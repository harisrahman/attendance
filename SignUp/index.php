			...
			<div class="container-fluid d-flex justify-content-center">
				<div id="form-div" class="col-xl-11">
					...
					<div class="form-control-feedback smallText" id="$unknownError">
						...
						<input type="submit" id="submitButton" name="submit" class="btn btn-primary btn-lg offset-sm-5" onclick="this.value='Submitting ..'; this.form.submit(); this.disabled='disabled';" value="Submit">
						<br>
					</form><br>
				</div>
			</div>
...
http://www.quackit.com/bootstrap/bootstrap_4/tutorial/bootstrap_forms.cfm
http://www.quackit.com/bootstrap/bootstrap_4/tutorial/bootstrap_custom_forms.cfm
https://www.eduonix.com/blog/web-programming-tutorials/learn-forms-form-features-bootstrap-4/
...
stackoverflow.com/questions/572768/styling-an-input-type-file-button
