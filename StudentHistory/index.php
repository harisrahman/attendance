...
<html lang="en">
  <head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<script src="StudentHistoryJS.js"></script>
		<script src="StudentHistoryJQ.js"></script>

		<script>
		window.onload = function () {

			CanvasJS.addColorSet("customColorSetForColumn", [ 
				"#51cda0"
			]);

			CanvasJS.addColorSet("customColorSetForPie", [ 
				"#e05850",
				"#9bbb58"
			]);
		...
		var allStudentsInWeek = new CanvasJS.Chart("allStudentsInWeekChart", {
			...
			colorSet: "customColorSetForColumn",
			exportEnabled: true,
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						<?php if(isset($navCreation)){echo($navCreation);}; ?>">
					</ul>
				</div>
			</div>
		</nav>
...
//No records modal
					...
					<div class="row">
						<div class="col-lg-8">
							<h2 class="header">
								<span id="className" class="text-light"><?=$sRollName?></span>
					...
					<div class="row">
						<div class="col-md-12 mb-4" id="weekAttendanceDiv">
							<div class="card card-block">
								<h4 class="card-header">Your Attendance This Week</h4>
					...
					<div class="row mb-5">
							<div class="col-lg-8" id="allStudentsInWeekDiv">
								<div class="card card-block shadow" style="overflow: auto;">
									<h4 class="card-header">Class Attendance This Week</h4>
									<div id="allStudentsInWeekChart" style="width: <?=$allStudentsInWeekChartWidth ?>px"></div>
								</div>
							</div>
							<div class="col-lg-4" id="averageStudentsInWeekDiv">
								<div class="card card-block shadow">
									<h4 class="card-header">Your Average Attendance In Week</h4>
					...
					<div class="row mb-5">
							<div class="col-lg-8" id="allStudentsInMonthDiv">
								<div class="card card-block shadow" style="overflow: auto;">
									<h4 class="card-header">Class Attendance This Month</h4>
							...
							<div class="col-lg-4" id="averageStudentsInMonthDiv">
								<div class="card card-block shadow">
									<h4 class="card-header">Your Average Attendance In Month</h4>
