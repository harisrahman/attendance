						...
						<div class="form-group">
							<div class="row nomarginleft">
								<div id="username" class="col-lg-8">
									...
									<input type="text" class="form-control <?php if(isset($errorClassOfusername)){echo($errorClassOfusername);}; ?>" id="username" name="username" placeholder="Username" minlength="6" maxlength="15" required="yes" value="<?php if(isset($username)){echo($username);}; ?>">
